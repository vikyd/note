...
<!--ts-->
   * [The Principles of Versioning in Go](#the-principles-of-versioning-in-go)
   * [Go 语言的模块版本管理原则](#go-语言的模块版本管理原则)
   * [目录](#目录)
   * [正文](#正文)
   * [为什么需要版本？](#为什么需要版本)
   * [软件工程中的版本](#软件工程中的版本)
   ...
   * [原则 #1：兼容性](#原则-1兼容性)
      * [反对的声音：审美](#反对的声音审美)
      * [反对的声音：新的 import 路径](#反对的声音新的-import-路径)
      * [反对的声音：一个构建中包含多个主版本号](#反对的声音一个构建中包含多个主版本号)
      * [反对的声音：不容易开发实验阶段的包](#反对的声音不容易开发实验阶段的包)
   * [原则 #2：可复现性](#原则-2可复现性)
      * [反对的声音：使用最新版本才是未来的趋势](#反对的声音使用最新版本才是未来的趋势)
      * [反对的声音：构建库程序时使用最新版本是一种功能](#反对的声音构建库程序时使用最新版本是一种功能)
   * [原则 #3：协作](#原则-3协作)
      * [反对的声音：使用可声明的不兼容性和 SAT 求解器](#反对的声音使用可声明的不兼容性和-sat-求解器)
   * [实例：Go 模块方案 vs 基于 SAT 的求解方案](#实例go-模块方案-vs-基于-sat-的求解方案)
   * [总结](#总结)
