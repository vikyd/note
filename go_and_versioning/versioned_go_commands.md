...
<!--ts-->
   * [Versioned Go Commands](#versioned-go-commands)
   * [Go 语言的版本管理命令](#go-语言的版本管理命令)
   * [目录](#目录)
   * [正文](#正文)
   * [一个古老的构建故事](#一个古老的构建故事)
   * [Go 语言的构建和隔离原则](#go-语言的构建和隔离原则)
   * [自动下载依赖](#自动下载依赖)
   * [修改模块版本（go get）](#修改模块版本go-get)
   * [模块信息（go list）](#模块信息go-list)
   * [准备新的模块版本（go release）](#准备新的模块版本go-release)
   * [模式匹配](#模式匹配)
   * [别再把项目代码放 GOPATH 里](#别再把项目代码放-gopath-里)
   * [下一步？](#下一步)
