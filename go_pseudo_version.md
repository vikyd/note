...
<!--ts-->
   * [Golang go mod 伪版本号的几种形式、产生原因](#golang-go-mod-伪版本号的几种形式产生原因)
   * [目录](#目录)
   * [go mod 的伪版本号官方定义](#go-mod-的伪版本号官方定义)
   * [go mod 的伪版本号实例](#go-mod-的伪版本号实例)
   * [实验](#实验)
      * [第 1 种伪版本号（主版本：v0）：vX.0.0-yyyymmddhhmmss-abcdefabcdef](#第-1-种伪版本号主版本v0vx00-yyyymmddhhmmss-abcdefabcdef)
      * [第 1 种伪版本号（主版本：v2）：vX.0.0-yyyymmddhhmmss-abcdefabcdef](#第-1-种伪版本号主版本v2vx00-yyyymmddhhmmss-abcdefabcdef)
      * [go get 可指定版本](#go-get-可指定版本)
      * [第 2 种伪版本号：vX.Y.Z-pre.0.yyyymmddhhmmss-abcdefabcdef](#第-2-种伪版本号vxyz-pre0yyyymmddhhmmss-abcdefabcdef)
      * [第 3 种伪版本号：vX.Y.(Z+1)-0.yyyymmddhhmmss-abcdefabcdef](#第-3-种伪版本号vxyz1-0yyyymmddhhmmss-abcdefabcdef)
      * [第 4 种伪版本号：vX.0.0-00010101000000-000000000000](#第-4-种伪版本号vx00-00010101000000-000000000000)
   * [在线检测 语义版本合法性](#在线检测-语义版本合法性)
   * [语义版本的正常版本](#语义版本的正常版本)
   * [语义版本号的伪版本号](#语义版本号的伪版本号)
   * [补充说明](#补充说明)
      * [+incompatible 是什么？](#incompatible-是什么)
      * [// indirect 是什么？](#-indirect-是什么)
   * [go get 某些版本的失败情况](#go-get-某些版本的失败情况)
      * [情况 01：无 go.mod](#情况-01无-gomod)
      * [情况 02：有 go.mod 但版本不对](#情况-02有-gomod-但版本不对)
   * [伪版本号的一些特点](#伪版本号的一些特点)
   * [总结](#总结)
   * [其他参考](#其他参考)
