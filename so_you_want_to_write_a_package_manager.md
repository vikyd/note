...
<!--ts-->
   * [标题：So you want to write a package manager](#标题so-you-want-to-write-a-package-manager)
   * [译注](#译注)
   * [标题：如果你想写一个包管理器](#标题如果你想写一个包管理器)
   * [目录](#目录)
   * [正文](#正文)
   * [包管理器是个大坑，你最好别踩](#包管理器是个大坑你最好别踩)
   * [本文所说的 "包管理器"](#本文所说的-包管理器)
   * [我们碰到敌人了，敌人却是我们自己](#我们碰到敌人了敌人却是我们自己)
   * [状态与协议](#状态与协议)
      * [角色](#角色)
      * [管道中的管道](#管道中的管道)
   * [构造清单文件](#构造清单文件)
      ...
      * [参数化](#参数化)
      * [依赖包](#依赖包)
      * [等等，我们要聊下版本](#等等我们要聊下版本)
      * [没有版本的版本](#没有版本的版本)
      * [交换的原子](#交换的原子)
      * [其他思考](#其他思考)
   * [转化为 lock 文件](#转化为-lock-文件)
      * [算法](#算法)
      * [钻石依赖、SemVer、忍耐，我要发飙了](#钻石依赖semver忍耐我要发飙了)
      * [依赖包的参数化](#依赖包的参数化)
   * [编译器，最初阶段：从 lock 文件到依赖包源码](#编译器最初阶段从-lock-文件到依赖包源码)
   * [四种状态的变化](#四种状态的变化)
      * [新概念：匹配、同步、持久化](#新概念匹配同步持久化)
   * [结局](#结局)
   * [Go 语言 PDM](#go-语言-pdm)
      * [升级 go get](#升级-go-get)
      * [共享、monorepos（大仓库）、我可管理的最简单的 别那样做](#共享monorepos大仓库我可管理的最简单的-别那样做)
      * [语言版本控制与行动计划](#语言版本控制与行动计划)
